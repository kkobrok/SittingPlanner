...
export function GuestCard({ guest, assignment, seatPosition, onDragStart, onContextMenu, onMoveKeyboard }: GuestCardProps) {
  return (
    <div
      ...
      onContextMenu={e => { e.preventDefault(); onContextMenu?.(guest.id); }}
      tabIndex={0}
      onKeyDown={e => { if (e.key === 'Enter') onMoveKeyboard?.(guest.id); }}
